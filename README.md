...
Next.js 15: A React framework used for building server-side rendered and static web applications. It offers features like dynamic routing, improved performance, and SEO support.
Tailwind CSS: A utility-first CSS framework used for designing responsive and visually appealing UI components quickly.
APIs:
